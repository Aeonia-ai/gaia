...
Seven knowledge base tools defined as OpenAI-format functions:
...
7. `interact_with_experience` - Game experience interactions via unified state model
...
```python
# In unified_chat.py (lines 397 and 935):
